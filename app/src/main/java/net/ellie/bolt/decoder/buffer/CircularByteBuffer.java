...
public class CircularByteBuffer {
    ...
    public void read(byte[] dest, int offset, int length) throws InterruptedException {
        lock.lock();
        try {
            while (size < length) {
                notEmpty.await();
    ...
    public int readNonBlocking(byte[] dest, int offset, int length) {
        lock.lock();
        try {
    ...
    public int writeNonBlocking(byte[] data, int offset, int length) {
        lock.lock();
        try {
